...
public class SWWorld extends World {
	...
	public void initializeWorld(MessageRenderer iface) {
		...
		tim.setForceableLocations(); // set each actor to find it's available moveable locaitons
		...
		tom.setForceableLocations(); // set each actor to find it's available moveable locaitons
		...
		tony.setForceableLocations(); // set each actor to find it's available moveable locaitons
		...
		tina.setForceableLocations(); // set each actor to find it's available moveable locaitons
		...
		beru.setForceableLocations(); // set each actor to find it's available moveable locaitons
		
		UncleOwen owen = new UncleOwen(iface, this);
		owen.setSymbol("U");
		loc = myGrid.getLocationByCoordinates(8, 2);
		entityManager.setLocation(owen, loc);
		owen.setForceableLocations(); // set each actor to find it's available moveable locaitons

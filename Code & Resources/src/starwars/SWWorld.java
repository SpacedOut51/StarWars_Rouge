...
public class SWWorld extends World {
	...
	public void initializeWorld(MessageRenderer iface) {
		...
		// canteen within Ben's Path
		loc = myGrid.getLocationByCoordinates(6,7);
		SWEntity canteen_2 = new Canteen(iface, 10,10);
		canteen_2.setSymbol("o");
		canteen_2.setHitpoints(500);
		entityManager.setLocation(canteen, loc);
		canteen_2.addAffordance(new Take(canteen, iface));
		...
		//
		// R2-D2
		Direction [] r2d2_patrol = {CompassBearing.WEST, CompassBearing.WEST, CompassBearing.WEST, CompassBearing.WEST, CompassBearing.EAST, CompassBearing.EAST, CompassBearing.EAST, CompassBearing.EAST};
		Droid r2d2 = new Droid(Team.GOOD, 200, iface, this, false);
		r2d2.setName("R2-D2");
		r2d2.setSymbol("2");
		r2d2.setPath(r2d2_patrol);
		loc = myGrid.getLocationByCoordinates(4, 5);
